...
<!-- HelpSet auto-generated on Mon Mar 21 12:19:06 EDT 2022 -->
<helpset version="2.0">
	<title>fr60 HelpSet</title>
	<maps>
		<mapref location="fr60_map.xml" />
	</maps>
	<view mergetype="javax.help.UniteAppendMerge">
		<name>TOC</name>
		<label>Ghidra Table of Contents</label>
		<type>docking.help.CustomTOCView</type>
		<data>fr60_TOC.xml</data>
	</view>
	<view>
		<name>Search</name>
		<label>Search for Keywords</label>
		<type>docking.help.CustomSearchView</type>
		<data engine="com.sun.java.help.search.DefaultSearchEngine">fr60_JavaHelpSearch</data>
	</view>
	<view>
		<name>Favorites</name>
